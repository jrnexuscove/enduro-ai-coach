...
- **Next actions (P0 order):** (1) Finish UI-TEST-1 — 5 remaining clips through fixed pipeline; (2) Wire KB retrieval into Stage 10 placeholder — measure coaching quality delta; (3) Parallelise S1–S4 with Promise.all — latency win, no architecture change; (4) Design coaching framework v2 — three-part structure, only after KB wiring proves the hypothesis.
